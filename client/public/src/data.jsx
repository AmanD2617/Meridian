...
const REASONING = [
  {
    ...
    body: (
      ...
      "Routing agent evaluated 4 alternates and selected transit via DXB with a 3°N southern offset. " +
    ...
    agents: [
      { a: "risk", msg: "Detected cyclone hazard HZ-021 intersecting route.", done: true },
      { a: "weather", msg: "Cyclone speed 42 km/h NE; forecast landfall +14h.", done: true },
      { a: "route", msg: "Evaluated alternates: {DXB-bridge, SHJ-bridge, direct-south-38}.", done: true },
  ...
  },
  {
    ...
    alertId: "HZ-014",
    body: (
      "Storm front HZ-014 blocks 38°N corridor. Routing agent selected great-circle northern track via Anchorage. " +
    ...
    agents: [
      { a: "risk", msg: "HZ-014 blocks primary Pacific corridor.", done: true },
      { a: "route", msg: "Northern arc via ANC is viable; fuel +3.1%.", done: true },
  ...
  },
  {
    ...
    agents: [
      { a: "risk", msg: "Port of Rotterdam dwell +171% vs 30d baseline.", done: true },
  ...
  },
  {
    ...
    agents: [
      ...
      { a: "route", msg: "No cheaper alternate; accept delay.", done: true },
    ],
  },
];
