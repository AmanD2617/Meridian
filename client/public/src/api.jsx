...
function buildTrace(doc) {
  ...
  return [
    { a: "risk",    msg: `Detected hazard ${doc.alertHumanId} intersecting active route.`, done: true },
    { a: "weather", msg: "Assessed corridor impact, severity and clearance window.",       done: true },
    { a: "route",   msg: `Evaluated alternates — selected ${doc.selectedAlternate}.`,      done: true },
    {
      a: "orchestrator",
      msg: isPending
