...
function AgentTag({ agent }) {
  const label = { risk:"Risk Agent", route:"Routing Agent", weather:"Weather Agent", orchestrator:"Orchestrator" }[agent] || agent;
...
function ReasoningPanel({ onSelectShip, onApprove, onReject, entries }) {
  return (
    <div className="right">
